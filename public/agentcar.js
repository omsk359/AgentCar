...
function main() { 
    jQuery(document).ready(function($) { 
		...
		var ac_html = '<div class="agent_car_border"><div class="agent_car_body"><div class="agent_car_logo"></div></div></div>',
			...
			ac_i_have = '<div class="agent_car_group" id="agent_car_i_have"><label for="agent_car_i_have">У меня есть</label><div class="agent_car_cell"><input name="agent_car_i_have" type="text" value=""/></div></div>',
			ac_i_credit = '<div class="agent_car_group" id="agent_car_credit"><label for="agent_car_credit">Я хочу кредит</label><div class="agent_car_cell"><input name="agent_car_credit" id="agent_car_credit" type="checkbox" value=""/></div></div>',
			ac_i_credit_pay = '<div class="agent_car_group" id="agent_car_credit_pay"><label for="agent_car_credit_pay">с ежимесячным платежом</label><div class="agent_car_cell"><input name="agent_car_credit_pay" type="text" value="10000"/></div></div>',
			ac_i_credit_time = '<div class="agent_car_group" id="agent_car_credit_time"><label for="agent_car_credit_time">сроком на</label><div class="agent_car_cell"><select name="agent_car_credit_time" id=""><option value="12">12</option><option value="24">24</option><option value="36">36</option><option value="60">60</option></select></div></div>',
			...
			ac_cost = '<div class="agent_car_group" id="agent_car_my_car_cost"><label for="agent_car_my_car_cost">Моя машина стоит</label><div class="agent_car_cell"><input name="agent_car_my_car_cost" type="text" value="300000"/></div></div>',
		...
		$( ".agent_car_body" ).append( ac_close, ac_form_want, ac_i_have, ac_i_credit, ac_i_credit_pay, ac_i_credit_time, ac_trade_in, ac_cost, ac_run);
