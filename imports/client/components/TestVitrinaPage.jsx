...
export default class TestVitrinaPageDumb extends React.Component {
    componentWillMount() {
...
// TestVitrinaPageDumb.propTypes = {
//     reserveCars: React.PropTypes.array,
//     stats: React.PropTypes.object
// };

const TestVitrinaPage = createContainer(props => {
...
export default TestVitrinaPage